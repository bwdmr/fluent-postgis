...
extension QueryBuilder {
    /// Applies an ST_Contains filter to a joined model's field.
    @discardableResult
    public func filterGeometryContains<Joined, F, V>(
    ...
    /// Applies a reversed ST_Contains filter to a joined model's field.
    @discardableResult
    public func filterGeometryContains<Joined, F, V>(
        _ joined: Joined.Type,
        _ value: V,
