...
extension QueryBuilder {
    /// Applies an ST_Overlaps filter to a joined model's field.
    @discardableResult
    public func filterGeometryOverlaps<Joined, F, V>(
    ...
    /// Applies a reversed ST_Overlaps filter to a joined model's field.
    @discardableResult
    public func filterGeometryOverlaps<Joined, F, V>(
        _ joined: Joined.Type,
        _ value: V,
